    ...
    <div>
       <div className='shrink-0 w-75 h-60 p-5 bg-red-300 rounded-xl flex flex-col justify-between'>
            ...
            <div className='flex mt-5 justify-between'>
                <button className='bg-green-500 text-white px-3 py-1 text-sm rounded-lg'>Mark as Completed</button>
                <button className='bg-red-500 text-white px-3 py-1 text-sm rounded-lg'>Mark as Failed</button>
            </div>
